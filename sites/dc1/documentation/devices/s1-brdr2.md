...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet8 | routed | - | 10.255.0.13/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet8 | routed | - | 10.255.0.15/31 | default | 9214 | False | - | - |
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.1.4/32 |
...
| 10.255.0.12 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.0.14 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65004
   ...
   neighbor 10.255.0.12 description s1-spine1_Ethernet8
   neighbor 10.255.0.14 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.14 remote-as 65000
   neighbor 10.255.0.14 description s1-spine2_Ethernet8
   ...
   vlan 20
      rd 10.1.0.4:10020
      rd evpn domain remote 10.1.0.4:10020
