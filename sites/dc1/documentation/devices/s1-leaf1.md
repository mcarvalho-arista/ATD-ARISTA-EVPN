...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet2 | routed | - | 10.255.0.53/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet2 | routed | - | 10.255.0.55/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.0.14/32 |
...
| 10.255.0.52 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.0.54 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.0.14:10010 | 10010:10010 | - | - | learned |
| 20 | 10.1.0.14:10020 | 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.1.0.14:50001 | connected |
...
router bgp 65014
   ...
   neighbor 10.255.0.52 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.52 remote-as 65000
   neighbor 10.255.0.52 description s1-spine1_Ethernet2
   neighbor 10.255.0.54 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.54 remote-as 65000
   neighbor 10.255.0.54 description s1-spine2_Ethernet2
