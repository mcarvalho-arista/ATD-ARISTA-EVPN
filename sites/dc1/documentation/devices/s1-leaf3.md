...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet4 | routed | - | 10.255.0.57/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet4 | routed | - | 10.255.0.59/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.0.15/32 |
...
| 10.255.0.56 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.0.58 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.0.15:10010 | 10010:10010 | - | - | learned |
| 20 | 10.1.0.15:10020 | 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.1.0.15:50001 | connected |
...
router bgp 65015
   ...
   neighbor 10.255.0.56 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.56 remote-as 65000
   neighbor 10.255.0.56 description s1-spine1_Ethernet4
   neighbor 10.255.0.58 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.58 remote-as 65000
   neighbor 10.255.0.58 description s1-spine2_Ethernet4
