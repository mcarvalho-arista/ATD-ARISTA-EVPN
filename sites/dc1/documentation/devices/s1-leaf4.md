...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet5 | routed | - | 10.255.0.65/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet5 | routed | - | 10.255.0.67/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.0.17/32 |
...
| 10.255.0.64 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.0.66 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.0.17:10010 | 10010:10010 | - | - | learned |
| 20 | 10.1.0.17:10020 | 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.1.0.17:50001 | connected |
...
router bgp 65017
   ...
   neighbor 10.255.0.64 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.64 remote-as 65000
   neighbor 10.255.0.64 description s1-spine1_Ethernet5
   neighbor 10.255.0.66 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.0.66 remote-as 65000
   neighbor 10.255.0.66 description s1-spine2_Ethernet5
