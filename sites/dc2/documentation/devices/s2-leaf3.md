...
| --------- | --------------- | ------------ | --------- |
| LeafPair2 | Vlan4094 | 192.0.0.229 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf4_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_s2-leaf4_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet4 | routed | - | 10.255.1.201/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet4 | routed | - | 10.255.1.203/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_s2-leaf4_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.0.115/32 |
...
| Vlan4001 |  A  |  192.2.2.228/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.1.1.228/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.0.0.228/31  |  -  |  -  |  -  |  -  |  -  |
...
interface Vlan4001
   ...
   mtu 9214
   vrf A
   ip address 192.2.2.228/31
!
interface Vlan4093
   description MLAG_PEER_L3_PEERING
   no shutdown
   mtu 9214
   ip address 192.1.1.228/31
!
interface Vlan4094
...
| 10.255.1.200 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.1.202 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.1.1.229 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
| 192.2.2.229 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | A | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.0.115:10010 | 10010:10010 | - | - | learned |
| 20 | 10.1.0.115:10020 | 10020:10020 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.1.0.115:50001 | connected |
...
router bgp 65102
   ...
   neighbor 10.255.1.200 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.1.200 remote-as 65100
   neighbor 10.255.1.200 description s2-spine1_Ethernet4
   neighbor 10.255.1.202 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.1.202 remote-as 65100
   neighbor 10.255.1.202 description s2-spine2_Ethernet4
   neighbor 192.1.1.229 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.229 description s2-leaf4
   ...
   vrf A
      ...
      router-id 10.1.0.115
      neighbor 192.2.2.229 peer group MLAG-IPV4-UNDERLAY-PEER
