...
| --------- | --------------- | ------------ | --------- |
| LeafPair1 | Vlan4094 | 192.0.0.226 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s2-leaf1_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet6 | MLAG_PEER_s2-leaf1_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet3 | routed | - | 10.255.1.205/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet3 | routed | - | 10.255.1.207/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_s2-leaf1_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.0.116/32 |
...
interface Vlan4001
   ...
   mtu 9214
   vrf A
   ip address 192.2.2.227/31
!
interface Vlan4093
   description MLAG_PEER_L3_PEERING
   no shutdown
   mtu 9214
   ip address 192.1.1.227/31
!
interface Vlan4094
...
| 10.255.1.204 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.1.206 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.1.1.226 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
| 192.2.2.226 | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | A | - | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | Inherited from peer group MLAG-IPV4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.255.1.204 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.1.204 remote-as 65100
   neighbor 10.255.1.204 description s2-spine1_Ethernet3
   neighbor 10.255.1.206 peer group IPV4-UNDERLAY-PEERS
   neighbor 10.255.1.206 remote-as 65100
   neighbor 10.255.1.206 description s2-spine2_Ethernet3
   neighbor 192.1.1.226 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.226 description s2-leaf1
   ...
   vrf A
      ...
      router-id 10.1.0.116
      neighbor 192.2.2.226 peer group MLAG-IPV4-UNDERLAY-PEER
